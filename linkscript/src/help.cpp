...
========================================================
        NEBANIA ACTIVEFX LINKSCRIPT 1 ALPHA HELP
========================================================
History:
Created by   : Pilot0253
Developed by : logoro17 // LoRoGo17 
Linkscript and ActiveFX:
Created and Developed by:tohar777
USAGE:
...
BUILT-IN LIBRARIES:
  NOTE:NET,OS AND GUI LIBRARIES ARE DISABLED FOR SECURITY REASONS!,
  INSTEAD ACTIONFX ACTIOBOJECT.UI AND .NET WILL REPLACED A SAFE ALTERNATIEV
  [TIME & SYSTEM]
