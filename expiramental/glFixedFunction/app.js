...
var ASM_CONSTS = {
 ...
 125302: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 125385: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 125454: () => { return window.innerWidth; },  
 125484: () => { return window.innerHeight; }
};
