...
/** @type {function(string, boolean=, number=)} */
  ...
  onKeyPress:(event) => {
        ...
        ((a1, a2) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "vii", but no such functions have gotten exported!'))(GLFW.active.id, charCode);
      },
  onKeyChanged:(keyCode, status) => {
        ...
        if (GLFW.active.keyFunc) {
          ...
          ((a1, a2, a3, a4, a5) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "viiiii", but no such functions have gotten exported!'))(GLFW.active.id, key, keyCode, status, GLFW.getModBits(GLFW.active));
        }
      },
  ...
  onMouseenter:(event) => {
        ...
        if (GLFW.active.cursorEnterFunc) {
          ((a1, a2) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "vii", but no such functions have gotten exported!'))(GLFW.active.id, 1);
        }
      },
  onMouseleave:(event) => {
        if (!GLFW.active) return;
        ...
        if (GLFW.active.cursorEnterFunc) {
          ((a1, a2) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "vii", but no such functions have gotten exported!'))(GLFW.active.id, 0);
        }
      },
  onMouseButtonChanged:(event, status) => {
        ...
        if (GLFW.active.mouseButtonFunc) {
          ((a1, a2, a3, a4) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "viiii", but no such functions have gotten exported!'))(GLFW.active.id, eventButton, status, GLFW.getModBits(GLFW.active));
        }
      },
            ...
            if (gamepad) {
              if (!GLFW.joys[joy]) {
                ...
                if (GLFW.joystickFunc) {
                  ((a1, a2) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "vii", but no such functions have gotten exported!'))(joy, 0x00040001); // GLFW_CONNECTED
                }
              }
              ...
              if (GLFW.joys[joy]) {
                ...
                if (GLFW.joystickFunc) {
                  ((a1, a2) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "vii", but no such functions have gotten exported!'))(joy, 0x00040002); // GLFW_DISCONNECTED
                }
  ...
  destroyWindow:(winid) => {
        ...
        if (win.windowCloseFunc) {
          ((a1) => abort('Internal Error! Attempted to invoke wasm function pointer with signature "vi", but no such functions have gotten exported!'))(win.id);
        }
